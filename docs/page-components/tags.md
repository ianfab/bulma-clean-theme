...
Bulma tags are used in a few different layouts in Bulma Based Theme, so it has been extracted as it's own component. You can create a tag in your own pages using the below include tag.
